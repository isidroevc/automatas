...
public class PruebaEquivalencia {
	public static void main(String[] args) {
		...
		String[][] tabla2 = {{"q0", "q1"}, {"q1", "q2"}, {"q1", "q1"}}; 
		Lista<String> estadosFinales = new Lista<String>(new String[] {"q0"});
		...
		AFD<Character> automata2 = new AFD<Character>("q1", estadosFinales2, fdt2);
		ProcedimientoEquivalencia<Character> proc = automata.compararEquivalencia(automata2);
